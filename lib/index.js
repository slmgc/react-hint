...
exports.default = function (_ref) {
	...
	return _temp2 = _class = function (_Component) {
		...
		function ReactHint() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this._hint = createRef(), _this._container = createRef(), _this.state = { target: null, hidden: true }, _this.target = null, _this._containerStyle = { position: 'relative' }, _this.toggleEvents = function (_ref2, flag) {
				...
				var at = _this.target.getAttribute(attribute + '-at') || position;
